...
var QIDBEdb = function (_a) {
    ...
    return (React.createElement(SvgComponent, __assign({ viewBox: "0 0 32 32", className: "querypie_icon", "data-qi-has-multi-path": "true" }, props),
        ...
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M15.9994 13.5H13.9837C13.771 13.5 13.5989 13.6651 13.5989 13.869V18.8891V19.3988C13.5989 19.6143 13.7536 19.8306 13.9772 19.8306H15.9998C15.9787 20.233 15.4027 20.5369 14.0522 20.6807L13.899 20.6939C13.8079 20.7032 13.5989 20.6939 13.5989 21.0722V21.1726C13.5989 21.3765 13.7658 21.5556 13.9784 21.5556H15.9941C17.3204 21.5556 18.4011 20.5105 18.4011 19.2384V15.8036C18.4011 14.5315 17.326 13.5 15.9994 13.5Z", fill: "white" })));
};
