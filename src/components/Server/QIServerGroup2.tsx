...
export const QIServerGroup2: CustomizedSVGComponent = ({ ...props }) => (
  <SvgComponent
    viewBox="0 0 32 32"
    role="qp-icon"
  ...
  >
    ...
    />
    <path
      d="M7 19C7.55228 19 8 18.5523 8 18C8 17.4477 7.55228 17 7 17C6.44772 17 6 17.4477 6 18C6 18.5523 6.44772 19 7 19Z"
      fill="#818589"
    />
    <path
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M16 2H4C2.9 2 2 2.9 2 4V20C2 21.1 2.9 22 4 22H16C17.1 22 18 21.1 18 20V4C18 2.9 17.1 2 16 2ZM16 4V8H4V4H16ZM4 14V10H16V14H4ZM4 20V16H16V20H4Z"
      fill="#818589"
    />
    <path
      d="M14 28V24H16V28H28V24H20V22H28V18H20V16H28V12H20V10H28C29.1 10 30 10.9 30 12V28C30 29.1 29.1 30 28 30H16C14.9 30 14 29.1 14 28Z"
      fill="#818589"
    />
    <path
      d="M19 27C19.5523 27 20 26.5523 20 26C20 25.4477 19.5523 25 19 25C18.4477 25 18 25.4477 18 26C18 26.5523 18.4477 27 19 27Z"
      fill="#818589"
    />
    <path
    ...
    />
    <path
      d="M25 15C25.5523 15 26 14.5523 26 14C26 13.4477 25.5523 13 25 13C24.4477 13 24 13.4477 24 14C24 14.5523 24.4477 15 25 15Z"
      fill="#818589"
    />
    <path
      d="M23 14C23 14.5523 22.5523 15 22 15C21.4477 15 21 14.5523 21 14C21 13.4477 21.4477 13 22 13C22.5523 13 23 13.4477 23 14Z"
      fill="#818589"
    />
  </SvgComponent>
);
